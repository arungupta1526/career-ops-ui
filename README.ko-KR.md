...
> **🆕 최신 릴리스 — v1.84.0**
>
> **재적용 쿨다운 + pipeline.md 내 보상 정보**(상위 career-ops v1.15.0 패리티): EN 스캔이 이제 **최근 지원한 회사의 역할을 건너뜁니다**(`config/profile.yml → re_apply_windows:`, 기본값 비활성화)하여 결과가 새로운 채용 공고에 집중되고, 스캔된 채용 공고의 **급여**가 선택적 `url | <comp>` 열로 `data/pipeline.md`에 저장됩니다. v1.83.0(재게시 감지기), v1.82.0(NoDesk), v1.81.0(13개 신규 소스)을 기반으로 합니다.
>
> _13 locales · 6개 LLM 프로바이더 · 41개 스캐너 어댑터 · 재게시 감지기 · 재적용 쿨다운 · 상위 career-ops v1.15.0 패리티._
