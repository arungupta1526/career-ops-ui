...
[English](README.md) | [Español](README.es.md) | [Português (Brasil)](README.pt-BR.md) | **한국어** | [日本語](README.ja.md) | [Русский](README.ru.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [Français](README.fr.md) | [Polski](README.pl.md) | [Українська](README.uk.md) | [Dansk](README.da.md) | [العربية](README.ar.md)
...
> **🆕 최신 릴리스 — v1.80.0**
>
> **다섯 가지 스캔 업그레이드**([job-crawler](https://github.com/bracketouverte/job-crawler)의 아이디어를 재구현): **Teamtailor** 소스 — 테넌트별 `<slug>.teamtailor.com` 사이트를 공개 `/jobs.rss` 피드로 처리(총 **27개 어댑터**); **소스 격리(quarantine)** — 404/410으로 죽은 소스를 기록하고 이후 스캔에서 건너뜀(14일 후 자가 복구), 반복되는 죽은 슬러그 노이즈 제거; **Max per source** 상한 필드(기본값 ∞); **Posted within** 기간 필터(24h / 7d / 30d); 그리고 `#/scan`의 **저장된 검색 + ★ 즐겨찾기**, 방어적 검증과 함께 `localStorage`에 보존. v1.79.0(We Work Remotely), v1.78.x(국가 필터, 자동 새로고침, Enter→스캔, 클릭 가능한 로고), v1.77.0(덴마크어), v1.76.0(테넌트별 ATS 소스, `trust_filter`)을 기반으로 합니다.
>
> _13 locales · 6개 LLM 프로바이더 · 27개 스캐너 어댑터 · 저장된 검색 + 즐겨찾기 · 상위 career-ops v1.14.0 패리티._
...
> [English](README.md) · [Español](README.es.md) · [Português (Brasil)](README.pt-BR.md) · [日本語](README.ja.md) · [Русский](README.ru.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [Français](README.fr.md) · [Polski](README.pl.md) · [Українська](README.uk.md) · [العربية](README.ar.md)
