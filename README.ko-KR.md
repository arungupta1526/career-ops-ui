...
> **🆕 최신 릴리스 — v1.70.0**
>
> **새로운 세 가지 언어 — Polski, Українська, العربية (RTL) — 를 추가하여 UI가 12개 로케일로 확장되었으며, 상위 career-ops README와 동일합니다.** 아랍어는 진정한 우에서 좌로 쓰기 지원을 제공합니다. 언어 선택기는 이제 국기 `<select>` 드롭다운으로 변경되었으며, 상위 프로젝트의 자기소개서 모드가 `#/cover`에 추가되었습니다. 상위 career-ops v1.11.0을 따릅니다.
>
> _전체 테스트 **1086/1086** 통과 · 12개 로케일 · 문서 동기화 완료._
