...
> **🆕 최신 릴리스 — v1.77.0**
>
> **덴마크어(Dansk)가 13번째 인터페이스 언어로 추가되었습니다.** UI, 인앱 **도움말 가이드**(19 H2 / 75 H3), README, CHANGELOG의 덴마크어 전체 번역입니다. 덴마크어가 국기 언어 선택기에 합류했고, 전체 i18n 체계(어셈블러, 감사, 패리티 게이트, 스냅샷)가 이제 **13 locales**를 아우릅니다. v1.76.0(상위 career-ops v1.13.0 패리티 — 테넌트별 ATS 소스 6종 BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs, `trust_filter`, 무제한 스캔 결과, 타이틀 필터 견고성)과 v1.70–74(아랍어 RTL, 6개 LLM 프로바이더)을 기반으로 합니다.
>
> _13 locales · 6개 LLM 프로바이더 · 25개 스캐너 어댑터 · 상위 career-ops v1.13.0 패리티._
