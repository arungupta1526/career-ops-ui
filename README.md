...
>
> **Three new languages — Polski, Українська, العربية (RTL) — bring the UI to 12 locales, matching the parent career-ops README.** Arabic ships genuine right-to-left support. The language picker is now a flag `<select>` dropdown, and the parent's cover-letter mode lands at `#/cover`. Tracks parent career-ops v1.11.0.
>
> _Full suite **1086/1086** green · 12 locales · docs synced._
