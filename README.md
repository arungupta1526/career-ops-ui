...
> **🆕 Latest release — v1.83.0**
>
> **Repost / ghost-posting detector** (parent career-ops v1.15.0 parity): a new **🔁 Reposted / ghost roles** panel on `#/scan` flags company+role clusters re-listed under _different_ URLs within a rolling 90-day window — a stale-pipeline / ghost-posting signal — read from your scan history (`GET /api/scan/reposts`, fuzzy role-title matching, read-only). Builds on v1.82.0 (NoDesk), v1.81.0 (13 new sources), and v1.80.0 (Teamtailor, source quarantine, saved searches).
>
> _13 locales · 6 LLM providers · 41 scanner adapters · repost detector · parent career-ops v1.15.0 parity._
