...
> **🆕 Latest release — v1.77.0**
>
> **Danish (Dansk) added as the 13th interface language.** Full Danish translation of the UI, the in-app **Help guide** (19 H2 / 75 H3), the README, and the CHANGELOG. Danish joins the flag language picker, and the whole i18n machinery (assembler, audit, parity gates, snapshot) now spans **13 locales**. Builds on v1.76.0 (parent career-ops v1.13.0 parity — six per-tenant ATS sources BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs, `trust_filter`, uncapped scan results, title-filter robustness) and v1.70–74 (Arabic RTL, 6 LLM providers).
>
> _13 locales · 6 LLM providers · 25 scanner adapters · parent career-ops v1.13.0 parity._
