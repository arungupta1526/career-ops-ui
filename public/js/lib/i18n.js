...
window.I18n = (function () {
  ...
  const DICT = {
    ...
    'mode.runLive':    { en: 'Run live (Gemini)', es: 'Ejecutar en vivo (Gemini)', 'pt-BR': 'Executar ao vivo (Gemini)', ko: '실시간 실행 (Gemini)', ja: 'ライブ実行 (Gemini)', ru: 'Запустить вживую (Gemini)', 'zh-CN': '实时运行 (Gemini)', 'zh-TW': '即時執行 (Gemini)' },
    ...
    'deep.runLive':   { en: '⚡ Run live (Gemini)', es: '⚡ Ejecutar en vivo (Gemini)', 'pt-BR': '⚡ Executar ao vivo (Gemini)', ko: '⚡ 실시간 실행 (Gemini)', ja: '⚡ ライブ実行 (Gemini)', ru: '⚡ Запустить вживую (Gemini)', 'zh-CN': '⚡ 实时运行 (Gemini)', 'zh-TW': '⚡ 即時執行 (Gemini)' },
