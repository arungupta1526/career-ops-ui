...
[career-ops](https://career-ops.org) نظام مفتوح المصدر للبحث عن عمل، يعمل عبر أوامر مائلة داخل أي واجهة سطر أوامر لبرمجة الذكاء الاصطناعي (Claude Code، Codex، OpenCode، Qwen CLI — وأي واجهة متوافقة مع Claude تعمل بالطريقة ذاتها). النظام مستقل عن النموذج المستخدم. يقيّم كل إعلان وظيفي مقابل سيرتك الذاتية CV وفق معيار سداسي الأبعاد يتراوح بين 0.0 و5.0، ويُنشئ سيرًا ذاتية PDF مخصصة، ويتتبع كل طلب توظيف محلياً على جهازك.
...
|---|---|---|
| أين يعمل | داخل Claude Code / Codex / OpenCode / Qwen CLI | `http://127.0.0.1:4317` في متصفحك |
