...
Интерфейс поставляется на 8 языках (English, Español, Português, 한국어, 日本語, Русский, 简体中文, 繁體中文). Каждая надпись на экране берётся из словаря переводов, и вы можете добавить или поправить язык, не трогая логику приложения.
