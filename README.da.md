...
> **🆕 Seneste udgivelse — v1.84.0**
>
> **Genansøgnings-cooldown + kompensation i pipeline.md** (paritet med forælderens career-ops v1.15.0): EN-scanningen **springer nu over roller hos virksomheder, du har søgt hos for nylig** (`config/profile.yml → re_apply_windows:`, slået fra som standard), så resultaterne forbliver fokuserede på nye opslag, og scannede opslag gemmer deres **løn** som en valgfri `url | <comp>`-kolonne i `data/pipeline.md`. Bygger videre på v1.83.0 (genoplagsdetektor), v1.82.0 (NoDesk) og v1.81.0 (13 nye kilder).
>
> _13 lokaliteter · 6 LLM-providere · 41 scanneradaptere · genoplagsdetektor · genansøgnings-cooldown · paritet med forælderens career-ops v1.15.0._
