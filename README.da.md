...
> **🆕 Seneste udgivelse — v1.81.0**
>
> **13 nye jobscanningskilder** (paritet med forælderens career-ops): boards-dækkende offentlige API'er **Arbeitnow · Himalayas · Jobicy · Landing.jobs · 4 Day Week · The Muse · The Hub · Jobspresso · Hacker News "Who is hiring?"**, de polske boards **JustJoin.it · NoFluffJobs** (POST-søgning) og per-tenant ATS **Pinpoint · Rippling** (auto-detekteret fra `careers_url`) — alle host-låste med `redirect:'error'` (SSRF-sikrede) og valgbare i **Source**-dropdownen på `#/scan` (**40 adaptere** i alt). Bygger videre på v1.80.0 (Teamtailor, kildekarantæne, maks. pr. kilde, aldersfilter, gemte søgninger), v1.79.0 (We Work Remotely), v1.77.0 (dansk) og v1.76.0 (per-tenant ATS-kilder).
>
> _13 lokaliteter · 6 LLM-providere · 40 scanneradaptere · 13 nye kilder · paritet med forælderens career-ops._
