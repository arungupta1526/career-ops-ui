...
> **🆕 Seneste udgivelse — v1.77.0**
>
> **Dansk tilføjet som det 13. interface-sprog.** Fuld dansk oversættelse af brugerfladen, den indbyggede **hjælpeguide** (19 H2 / 75 H3), README og CHANGELOG. Dansk slutter sig til flag-sprogvælgeren, og hele i18n-maskineriet (assembler, audit, paritetsporte, snapshot) spænder nu over **13 lokaliteter**. Bygger videre på v1.76.0 (paritet med forælderens career-ops v1.13.0 — seks ATS-kilder pr. tenant BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs, `trust_filter`, scanresultater uden loft, robusthed i titelfilteret) og v1.70–74 (arabisk RTL, 6 LLM-providere).
>
> _13 lokaliteter · 6 LLM-providere · 25 scanneradaptere · paritet med forælderens career-ops v1.13.0._
