...
> **🆕 Seneste udgivelse — v1.83.0**
>
> **Genopslags-/spøgelsesstillings-detektor** (paritet med forælderens career-ops v1.15.0): et nyt panel **🔁 Genopslåede / spøgelsesstillinger** på `#/scan` markerer firma+stilling-klynger, der er genopslået under forskellige URL'er inden for et rullende 90-dages vindue — et signal om forældet pipeline / spøgelsesstillinger — læst fra din scanningshistorik (`GET /api/scan/reposts`). Bygger videre på v1.82.0 (NoDesk), v1.81.0 (13 nye kilder) og v1.80.0 (Teamtailor, kildekarantæne, gemte søgninger).
>
> _13 lokaliteter · 6 LLM-providere · 41 scanneradaptere · genoplagsdetektor · paritet med forælderens career-ops v1.15.0._
