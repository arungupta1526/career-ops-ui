...
> **🆕 Última versão — v1.77.0**
>
> **O dinamarquês (Dansk) foi adicionado como 13.º idioma da interface.** Tradução completa para o dinamarquês da interface, do **guia de ajuda** integrado (19 H2 / 75 H3), do README e do CHANGELOG. O dinamarquês entra no seletor de idioma com bandeiras, e toda a maquinaria de i18n (montador, auditoria, controles de paridade, snapshot) agora abrange **13 locales**. Baseia-se na v1.76.0 (paridade com o career-ops pai v1.13.0 — seis fontes ATS por tenant BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs, `trust_filter`, resultados de varredura sem limite, robustez do filtro de títulos) e na v1.70–74 (árabe RTL, 6 provedores LLM).
>
> _13 locales · 6 provedores LLM · 25 adaptadores de scanner · paridade com o career-ops pai v1.13.0._
