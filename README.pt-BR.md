...
> **🆕 Última versão — v1.84.0**
>
> **Cooldown de recandidatura + compensação em pipeline.md** (paridade com career-ops v1.15.0): o scan EN agora **ignora vagas em empresas às quais você se candidatou recentemente** (`config/profile.yml → re_apply_windows:`, desativado por padrão) para que os resultados fiquem focados em novas vagas, e as vagas varridas persistem seu **salário** como coluna opcional `url | <comp>` em `data/pipeline.md`. Baseia-se na v1.83.0 (detector de repostagens), v1.82.0 (NoDesk) e v1.81.0 (13 novas fontes).
>
> _13 locales · 6 provedores LLM · 41 adaptadores de scanner · detector de repostagens · cooldown de recandidatura · paridade com career-ops v1.15.0._
