...
> **🆕 Última versão — v1.81.0**
>
> **13 novas fontes de varredura de bolsas de emprego** (paridade com o career-ops pai): APIs públicas universais **Arbeitnow · Himalayas · Jobicy · Landing.jobs · 4 Day Week · The Muse · The Hub · Jobspresso · Hacker News "Who is hiring?"**, as bolsas polonesas **JustJoin.it · NoFluffJobs** (busca POST) e ATS por tenant **Pinpoint · Rippling** (autodetectados de `careers_url`) — todas fixadas por host com `redirect:'error'` (anti-SSRF) e selecionáveis no menu **Source** de `#/scan` (**40 adaptadores** no total). Baseia-se na v1.80.0 (Teamtailor, quarentena de fontes, máx. por fonte, filtro de idade, buscas salvas), na v1.79.0 (We Work Remotely), na v1.77.0 (dinamarquês) e na v1.76.0 (fontes ATS por tenant).
>
> _13 locales · 6 provedores LLM · 40 adaptadores de scanner · 13 novas fontes · paridade com o career-ops pai._
