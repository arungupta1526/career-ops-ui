...
> **🆕 Última versão — v1.82.0**
>
> **Fonte de varredura NoDesk** (paridade com career-ops v1.15.0): o feed RSS de vagas remotas do [NoDesk](https://nodesk.co) agora é uma fonte de primeira classe — adicione uma entrada `provider: nodesk` e ela aparece no menu **Source** de `#/scan` (**41 adaptadores** no total). Host fixado em `nodesk.co` com `redirect:'error'` (anti-SSRF); títulos divididos por `Role at Company`. Baseia-se na v1.81.0 (13 novas fontes), v1.80.0 (Teamtailor, quarentena de fontes, buscas salvas) e v1.77.0 (dinamarquês).
>
> _13 locales · 6 provedores LLM · 41 adaptadores de scanner · paridade com career-ops v1.15.0._
