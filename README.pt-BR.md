...
> **🆕 Última versão — v1.70.0**
>
> **Três novos idiomas — Polski, Українська, العربية (RTL) — elevam a UI para 12 localidades, igualando o README principal do career-ops.** O árabe inclui suporte genuíno a escrita da direita para a esquerda. O seletor de idioma agora é um `<select>` suspensão com bandeiras, e o modo de carta de apresentação do projeto principal chega ao `#/cover`. Acompanha o career-ops v1.11.0.
>
> _Suite completa **1086/1086** verde · 12 localidades · documentação sincronizada._
