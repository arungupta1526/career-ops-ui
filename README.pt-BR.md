...
> **v1.67.0 — filtro de faixa salarial em `#/scan`.** A tabela de resultados ganha dois campos numéricos — **salário de / até** — ao lado dos filtros de texto e remoto. O salário em texto livre de cada linha (`от 100 000 до 200 000 ₽`, `120000-150000 USD`, `$120K–$150K`, …) é parseado para uma faixa numérica e comparado com semântica de faixas sobrepostas; linhas sem salário publicado seguem visíveis, então o filtro estreita em vez de esvaziar a lista (sem considerar a moeda — sem conversão). Também eleva o timeout de fetch por fonte **15s → 30s** para os quadros Ashby lentos pararem de expirar. Suíte completa **1060/1060** verde.
