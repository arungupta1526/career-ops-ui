...
>
> **2. Timeout de fetch por fonte elevado de 15s → 30s** (override com `SCAN_FETCH_TIMEOUT_MS`). Os payloads `includeCompensation` do Ashby costumavam levar mais de 15s sob concorrência ×8, então ~30 quadros Ashby expiravam a cada varredura; 30s deixa as fontes lentas mas vivas terminarem.
>
> _13 novos testes · suíte completa **1060/1060** verde · i18n + docs sincronizados nos 9 idiomas._
