...
> **🆕 Última versão — v1.83.0**
>
> **Detector de repostagens / vagas fantasma** (paridade com career-ops v1.15.0): um novo painel **🔁 Repostagens / vagas fantasma** em `#/scan` sinaliza clusters empresa+vaga relançados sob URLs diferentes em uma janela móvel de 90 dias — sinal de pipelines obsoletas e vagas fantasma — lidos do seu histórico de varredura (`GET /api/scan/reposts`). Baseia-se na v1.82.0 (NoDesk), v1.81.0 (13 novas fontes) e v1.80.0 (Teamtailor, quarentena de fontes, buscas salvas).
>
> _13 locales · 6 provedores LLM · 41 adaptadores de scanner · detector de repostagens · paridade com career-ops v1.15.0._
