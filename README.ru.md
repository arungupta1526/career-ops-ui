...
> **🆕 Последний релиз — v1.77.0**
>
> **Датский (Dansk) добавлен как 13-й язык интерфейса.** Полный перевод на датский интерфейса, встроенного **руководства помощи** (19 H2 / 75 H3), README и CHANGELOG. Датский присоединяется к выбору языка с флагами, а вся машинерия i18n (ассемблер, аудит, проверки паритета, снапшот) теперь охватывает **13 locales**. Основан на v1.76.0 (паритет с родительским career-ops v1.13.0 — шесть источников ATS на тенант BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs, `trust_filter`, неограниченные результаты сканирования, устойчивость фильтра заголовков) и v1.70–74 (арабский RTL, 6 LLM-провайдеров).
>
> _13 locales · 6 LLM-провайдеров · 25 адаптеров сканера · паритет с родительским career-ops v1.13.0._
