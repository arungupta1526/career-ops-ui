...
> **🆕 Последний релиз — v1.81.0**
>
> **13 новых источников сканирования вакансий** (паритет с родительским career-ops): общедоступные API досок **Arbeitnow · Himalayas · Jobicy · Landing.jobs · 4 Day Week · The Muse · The Hub · Jobspresso · Hacker News "Who is hiring?"**, польские доски **JustJoin.it · NoFluffJobs** (POST-поиск) и per-tenant ATS **Pinpoint · Rippling** (автоопределение по `careers_url`) — все закреплены по хосту с `redirect:'error'` (защита от SSRF) и доступны в выпадающем списке **Source** на `#/scan` (всего **40 адаптеров**). Основан на v1.80.0 (Teamtailor, карантин источников, макс. на источник, фильтр по возрасту, сохранённые поиски), v1.79.0 (We Work Remotely), v1.77.0 (датский) и v1.76.0 (источники ATS на тенант).
>
> _13 locales · 6 LLM-провайдеров · 40 адаптеров сканера · 13 новых источников · паритет с родительским career-ops._
