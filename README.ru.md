...
[English](README.md) | [Español](README.es.md) | [Português (Brasil)](README.pt-BR.md) | [한국어](README.ko-KR.md) | [日本語](README.ja.md) | **Русский** | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [Français](README.fr.md) | [Polski](README.pl.md) | [Українська](README.uk.md) | [Dansk](README.da.md) | [العربية](README.ar.md)

_Неофициальный интерфейс — не аффилирован с career-ops / santifer и не одобрен ими._

[![tests](https://img.shields.io/badge/tests-1222%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.78.0**
>
> **Гео-фильтр на странице сканирования — фильтруйте результаты вакансий по стране, с флагами.** Новый выпадающий список **Country** на `#/scan` перечисляет каждую страну, обнаруженную в ваших отсканированных результатах (эмодзи флага + счётчик), позволяя оставить только вакансии, привязанные к конкретной стране — рядом с фильтром типа работы Remote / Hybrid / Onsite, так что вы можете искать как работу, привязанную к стране, **так и** удалённую. Новый хелпер `countries.js` сопоставляет свободный текст локации каждой вакансии (названия стран, алиасы и ~100 крупных городов рынка труда) с ISO-страной + флагом; детектирование консервативно и никогда не угадывает. Основан на v1.77.0 (датский, 13-я локаль) и v1.76.0 (паритет с родительским career-ops v1.13.0 — шесть источников ATS на тенант, `trust_filter`, неограниченные результаты сканирования).
>
> _13 locales · 6 LLM-провайдеров · 25 адаптеров сканера · фильтр по стране · паритет с родительским career-ops v1.13.0._
...
> [English](README.md) · [Español](README.es.md) · [Português (Brasil)](README.pt-BR.md) · [한국어](README.ko-KR.md) · [日本語](README.ja.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [Français](README.fr.md) · [Polski](README.pl.md) · [Українська](README.uk.md) · [العربية](README.ar.md)
