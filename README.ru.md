...
> **🆕 Последний релиз — v1.70.0**
>
> **Три новых языка — Polski, Українська, العربية (RTL) — доводят UI до 12 локалей, совпадая с README основного проекта career-ops.** Арабский язык поставляется с полноценной поддержкой письма справа налево. Выбор языка теперь оформлен в виде выпадающего `<select>` с флагами, а режим сопроводительного письма основного проекта доступен по адресу `#/cover`. Соответствует career-ops v1.11.0.
>
> _Полный набор тестов **1086/1086** пройден · 12 локалей · документация синхронизирована._
