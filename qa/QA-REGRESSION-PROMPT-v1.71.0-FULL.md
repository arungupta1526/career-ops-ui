...
- `#/help`: 9 markdown bundles (en/es/pt-BR/ko-KR/ja/ru/zh-CN/zh-TW/fr); **pl/uk/ar fall back to `en.md`** via the resolver — confirm the fallback actually serves en (no 404). Help invariant: 19 H2 / 75 H3 (`canonical-docs-coverage` + `help-ui` + `help-ru-config-section`).
