...
>
> **Repo state.** v1.58.6 (2026-05-20). 901 `node --test` cases,
> 60 Playwright (smoke + full-cycle + forms). v1.55.1→v1.56.4 consolidated UX fix-prompt
...
**Test baseline (v1.58.6):** 901/901 unit · 60/60 Playwright (smoke + full-cycle + forms) · 20/20 smoke E2E · 23/23 comprehensive E2E.
