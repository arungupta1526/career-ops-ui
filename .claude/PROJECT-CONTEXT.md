...
>
> **Repo state.** v1.58.7 (2026-05-20). 903 `node --test` cases,
...
**Test baseline (v1.58.7):** 903/903 unit · 60/60 Playwright (smoke + full-cycle + forms) · 20/20 smoke E2E · 23/23 comprehensive E2E.
