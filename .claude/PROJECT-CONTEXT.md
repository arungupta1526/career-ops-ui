...
>
> **Repo state.** v1.58.51 (2026-05-20). 947 `node --test` cases,
> 62 Playwright (smoke + full-cycle + forms — incl. new drawer end-to-end). v1.55.1→v1.56.4 consolidated UX fix-prompt
...
**Test baseline (v1.58.51):** 947/947 unit · 62/62 Playwright (smoke + full-cycle + forms — incl. new drawer end-to-end) · 20/20 smoke E2E · 23/23 comprehensive E2E.
