...
>
> **2. Timeout de fetch por fuente fijado en 10s (fail-fast).** Subirlo a 30s en v1.67.0 recuperó solo ~la mitad de los tableros Ashby lentos; el resto (Perplexity, Supabase, Resend, DeepL, Ramp, …) se cuelga sin importar el deadline, así que un timeout mayor solo estancaba cada escaneo esperando ranuras muertas. 10s falla rápido en los crónicos y mantiene el escaneo ágil; override con `SCAN_FETCH_TIMEOUT_MS`.
>
> _Suite completa **1060/1060** en verde · i18n + docs sincronizados en los 9 idiomas._
