...
> **🆕 Última versión — v1.83.0**
>
> **Detector de reposteos / empleos fantasma** (paridad con career-ops v1.15.0): un nuevo panel **🔁 Reposteos / empleos fantasma** en `#/scan` señala los clústeres empresa+rol publicados de nuevo bajo distintas URLs en una ventana móvil de 90 días — señal de pipelines obsoletas y empleos fantasma — leídos desde tu historial de escaneo (`GET /api/scan/reposts`). Se basa en la v1.82.0 (NoDesk), la v1.81.0 (13 nuevas fuentes) y la v1.80.0 (Teamtailor, cuarentena de fuentes, búsquedas guardadas).
>
> _13 locales · 6 proveedores LLM · 41 adaptadores de escáner · detector de reposteos · paridad con el career-ops v1.15.0._
