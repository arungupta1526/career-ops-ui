...
> **🆕 Última versión — v1.84.0**
>
> **Cooldown de repostulación + compensación en pipeline.md** (paridad con career-ops v1.15.0): el escaneo EN ahora **omite roles en empresas a las que postulaste recientemente** (`config/profile.yml → re_apply_windows:`, desactivado por defecto) para que los resultados se centren en nuevas ofertas, y las ofertas escaneadas persisten su **salario** como columna opcional `url | <comp>` en `data/pipeline.md`. Se basa en la v1.83.0 (detector de reposteos), la v1.82.0 (NoDesk) y la v1.81.0 (13 nuevas fuentes).
>
> _13 locales · 6 proveedores LLM · 41 adaptadores de escáner · detector de reposteos · cooldown de repostulación · paridad con el career-ops v1.15.0._
