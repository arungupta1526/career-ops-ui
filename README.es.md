...
> **🆕 Última versión — v1.82.0**
>
> **Fuente de escaneo NoDesk** (paridad con career-ops v1.15.0): el feed RSS de empleo remoto de [NoDesk](https://nodesk.co) ahora es una fuente de primera clase — añade una entrada `provider: nodesk` y aparece en el desplegable **Source** de `#/scan` (**41 adaptadores** en total). Host fijado a `nodesk.co` con `redirect:'error'` (anti-SSRF); los títulos se dividen por `Role at Company`. Se basa en la v1.81.0 (13 nuevas fuentes), la v1.80.0 (Teamtailor, cuarentena de fuentes, búsquedas guardadas) y la v1.77.0 (danés).
>
> _13 locales · 6 proveedores LLM · 41 adaptadores de escáner · paridad con el career-ops v1.15.0._
