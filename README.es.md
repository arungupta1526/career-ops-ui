...
> **🆕 Última versión — v1.77.0**
>
> **El danés (Dansk) se añade como 13.º idioma de la interfaz.** Traducción completa al danés de la interfaz, la **guía de ayuda** integrada (19 H2 / 75 H3), el README y el CHANGELOG. El danés se suma al selector de idioma con banderas, y toda la maquinaria de i18n (ensamblador, auditoría, controles de paridad, snapshot) abarca ahora **13 locales**. Se basa en la v1.76.0 (paridad con el career-ops padre v1.13.0 — seis fuentes ATS por tenant BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs, `trust_filter`, resultados de escaneo sin límite, robustez del filtro de títulos) y la v1.70–74 (árabe RTL, 6 proveedores LLM).
>
> _13 locales · 6 proveedores LLM · 25 adaptadores de escáner · paridad con el career-ops padre v1.13.0._
