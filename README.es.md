...
> **🆕 Última versión — v1.70.0**
>
> **Tres nuevos idiomas — Polski, Українська, العربية (RTL) — llevan la UI a 12 idiomas, igualando el README principal de career-ops.** El árabe incluye soporte real de derecha a izquierda. El selector de idioma es ahora un desplegable `<select>` con banderas, y el modo de carta de presentación del proyecto principal llega a `#/cover`. Sigue a career-ops v1.11.0.
>
> _Suite completa **1086/1086** verde · 12 idiomas · documentación sincronizada._
