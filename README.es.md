...
[English](README.md) | **Español** | [Português (Brasil)](README.pt-BR.md) | [한국어](README.ko-KR.md) | [日本語](README.ja.md) | [Русский](README.ru.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [Français](README.fr.md) | [Polski](README.pl.md) | [Українська](README.uk.md) | [Dansk](README.da.md) | [العربية](README.ar.md)
...
> **🆕 Última versión — v1.80.0**
>
> **Cinco mejoras de escaneo** (ideas de [job-crawler](https://github.com/bracketouverte/job-crawler), reimplementadas): una fuente **Teamtailor** — sitios `<slug>.teamtailor.com` por tenant a través de su feed público `/jobs.rss` (**27 adaptadores** en total); **cuarentena de fuentes** — las fuentes muertas 404/410 se registran y se omiten en escaneos posteriores (autorreparación tras 14 días), eliminando el ruido recurrente de slugs muertos; un campo de límite **Máximo por fuente** (∞ por defecto); un filtro de antigüedad **Publicado en los últimos** (24h / 7d / 30d); y **búsquedas guardadas + favoritos ★** en `#/scan`, persistidos en `localStorage` con validación defensiva. Se basa en la v1.79.0 (We Work Remotely), la v1.78.x (filtro por país, autoactualización, Enter→Escaneo, logo clicable), la v1.77.0 (danés) y la v1.76.0 (fuentes ATS por tenant, `trust_filter`).
>
> _13 locales · 6 proveedores LLM · 27 adaptadores de escáner · búsquedas guardadas + favoritos · paridad con el career-ops padre v1.14.0._
...
> [English](README.md) · [Português (Brasil)](README.pt-BR.md) · [한국어](README.ko-KR.md) · [日本語](README.ja.md) · [Русский](README.ru.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [Français](README.fr.md) · [Polski](README.pl.md) · [Українська](README.uk.md) · [العربية](README.ar.md)
