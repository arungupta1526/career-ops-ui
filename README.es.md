...
> **🆕 Última versión — v1.81.0**
>
> **13 nuevas fuentes de escaneo de bolsas de empleo** (paridad con el career-ops padre): APIs públicas universales **Arbeitnow · Himalayas · Jobicy · Landing.jobs · 4 Day Week · The Muse · The Hub · Jobspresso · Hacker News "Who is hiring?"**, las bolsas polacas **JustJoin.it · NoFluffJobs** (búsqueda POST) y ATS por tenant **Pinpoint · Rippling** (autodetectados desde `careers_url`) — todas fijadas por host con `redirect:'error'` (anti-SSRF) y seleccionables en el desplegable **Source** de `#/scan` (**40 adaptadores** en total). Se basa en la v1.80.0 (Teamtailor, cuarentena de fuentes, máx. por fuente, filtro de antigüedad, búsquedas guardadas), la v1.79.0 (We Work Remotely), la v1.77.0 (danés) y la v1.76.0 (fuentes ATS por tenant).
>
> _13 locales · 6 proveedores LLM · 40 adaptadores de escáner · 13 nuevas fuentes · paridad con el career-ops padre._
