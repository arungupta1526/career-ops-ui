...
> **🆕 最新リリース — v1.77.0**
>
> **デンマーク語(Dansk)が 13 番目のインターフェース言語として追加されました。** UI、アプリ内**ヘルプガイド**(19 H2 / 75 H3)、README、CHANGELOG のデンマーク語完全翻訳です。デンマーク語が国旗言語ピッカーに加わり、i18n の仕組み全体(アセンブラ、監査、パリティゲート、スナップショット)が **13 locales** をカバーするようになりました。v1.76.0(親 career-ops v1.13.0 パリティ — テナント単位の ATS ソース 6 件 BambooHR / Breezy HR / Comeet / Personio / Recruitee / SolidJobs、`trust_filter`、上限なしのスキャン結果、タイトルフィルタの堅牢化)および v1.70–74(アラビア語 RTL、6 つの LLM プロバイダ)をベースにしています。
>
> _13 locales · 6 LLM プロバイダ · 25 スキャナアダプタ · 親 career-ops v1.13.0 パリティ。_
