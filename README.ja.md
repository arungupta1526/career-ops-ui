...
> **🆕 最新リリース — v1.78.0**
>
> **スキャンページに地理フィルター — 求人結果を国別に、国旗付きで絞り込みます。** `#/scan` の新しい **Country** ドロップダウンは、スキャンした結果から検出されたすべての国を一覧表示し(国旗絵文字 + 件数)、特定の国に紐づく求人だけを残せます — Remote / Hybrid / Onsite の勤務形態フィルターと並んで提供され、国に紐づく求人**と**リモート求人の両方を検索できます。新しい `countries.js` ヘルパーが、各求人の自由記述の勤務地(国名、別名、~100 の主要求人市場都市)を ISO 国コード + 国旗にマッピングします。検出は保守的で、決して推測しません。v1.77.0(デンマーク語、13 番目のロケール)および v1.76.0(親 career-ops v1.13.0 パリティ — テナント単位の ATS ソース 6 件、`trust_filter`、上限なしのスキャン結果)をベースにしています。
>
