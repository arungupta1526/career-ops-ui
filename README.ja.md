...
[English](README.md) | [Español](README.es.md) | [Português (Brasil)](README.pt-BR.md) | [한국어](README.ko-KR.md) | **日本語** | [Русский](README.ru.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [Français](README.fr.md) | [Polski](README.pl.md) | [Українська](README.uk.md) | [Dansk](README.da.md) | [العربية](README.ar.md)
...
> **🆕 最新リリース — v1.80.0**
>
> **5 つのスキャン強化**([job-crawler](https://github.com/bracketouverte/job-crawler) のアイデアを再実装):**Teamtailor** ソース — テナント単位の `<slug>.teamtailor.com` サイトを公開の `/jobs.rss` フィード経由で取得します(合計 **27 アダプタ**);**ソースの隔離(quarantine)** — 404/410 で恒久的に死んだソースは記録され、以降のスキャンではスキップされます(14 日後に自己回復)。これにより、繰り返し発生する死んだ slug のノイズを解消します;**Max per source** 上限フィールド(既定では ∞);**Posted within** の経過時間フィルター(24h / 7d / 30d);そして `#/scan` 上の **保存済み検索 + ★ お気に入り** — `localStorage` に永続化され、防御的な検証付きです。v1.79.0(We Work Remotely)、v1.78.x(国フィルター、自動更新、Enter→スキャン、クリック可能なロゴ)、v1.77.0(デンマーク語)、v1.76.0(テナント単位の ATS ソース、`trust_filter`)をベースにしています。
>
> _13 ロケール · 6 LLM プロバイダ · 27 スキャナアダプタ · 保存済み検索 + お気に入り · 親 career-ops v1.14.0 パリティ。_
...
> [English](README.md) · [Español](README.es.md) · [Português (Brasil)](README.pt-BR.md) · [한국어](README.ko-KR.md) · [Русский](README.ru.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [Français](README.fr.md) · [Polski](README.pl.md) · [Українська](README.uk.md) · [العربية](README.ar.md)
