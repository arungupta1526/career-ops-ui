...
> **🆕 最新版本 — v1.70.0**
>
> **三種新語言 — Polski, Українська, العربية (RTL) — 使 UI 擴展至 12 個語言區域，與上層 career-ops README 保持一致。** 阿拉伯語提供真正的從右至左書寫支援。語言選擇器現在是帶國旗的 `<select>` 下拉選單，上層專案的求職信模式已在 `#/cover` 上線。跟隨上層 career-ops v1.11.0。
>
> _完整測試套件 **1086/1086** 通過 · 12 個語言區域 · 文件已同步。_
