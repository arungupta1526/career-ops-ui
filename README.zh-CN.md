...
> **🆕 最新版本 — v1.70.0**
>
> **三种新语言 — Polski, Українська, العربية (RTL) — 使 UI 扩展至 12 个语言区域，与上级 career-ops README 保持一致。** 阿拉伯语提供真正的从右到左书写支持。语言选择器现在是带国旗的 `<select>` 下拉菜单，上级项目的求职信模式已在 `#/cover` 上线。跟随上级 career-ops v1.11.0。
>
> _完整测试套件 **1086/1086** 通过 · 12 个语言区域 · 文档已同步。_
